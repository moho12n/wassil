...
Future<Response> makePostProposition(
    String content, String solution, String type, String nature) async {
  String json =
      '{"content":"$content", "solution":"$solution", "type":"$type", "nature":"$nature"}';
