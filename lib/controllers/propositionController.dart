...
Future<Response> makePostProposition(String title, String content,
    String solution, String type, String nature) async {
  String json =
      '{"title":"$title","content":"$content", "solution":"$solution", "type":"$type", "nature":"$nature"}';
  Response response = await post(Tools.domainName + "proposition",
